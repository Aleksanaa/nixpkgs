...
in
{
  format = buildHaxeLib {
    libname = "format";
    version = "3.5.0";
    hash = "sha256-5vZ7b+P74uGx0Gb7X/+jbsx5048dO/jv5nqCDtw5y/A=";
  ...
  heaps = buildHaxeLib {
    libname = "heaps";
    version = "1.9.1";
    hash = "sha256-i5EIKnph80eEEHvGXDXhIL4t4+RW7OcUV5zb2f3ItlI=";
  ...
  hlopenal = buildHaxeLib {
    libname = "hlopenal";
    version = "1.5.0";
    hash = "sha256-mJWFGBJPPAhVwsB2HzMfk4szSyjMT4aw543YhVqIan4=";
  ...
  hlsdl = buildHaxeLib {
    libname = "hlsdl";
    version = "1.10.0";
    hash = "sha256-kmC2EMDy1mv0jFjwDj+m0CUvKal3V7uIGnMxJBRYGms=";
