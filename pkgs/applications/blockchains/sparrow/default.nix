...
let
  ...
  src = fetchurl {
    ...
    hash = "sha256-b1OIizSMTOtLM3/RFiBJPSbkj/C0d0s5ggcUwjCdBBo=";
  ...
  manifest = fetchurl {
    ...
    hash = "sha256-2IGhP9Xsli9d0zTzPliJH/tE5TXei1vjVngtjL9vA48=";
  };
  ...
  manifestSignature = fetchurl {
    ...
    hash = "sha256-FSR9Z+27J/u1MYIR+LrL+pqCP6q4GfVYtRZ0WA9AaKM=";
  };
