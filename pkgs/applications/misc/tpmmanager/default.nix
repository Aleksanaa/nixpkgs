...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "TPMManager";
    rev = "v${version}";
    hash = "sha256-UZYn4ssbvLpdB0DssT7MXqQZCu1KkLf/Bsb45Rvgm+E=";
  };
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      hash = "sha256-gMhDNN2UkX2lJf/oJEzOkCvF6+EGdIj9xwtXb1rCeys=";
    })
    (fetchpatch {
      url = "https://github.com/Rohde-Schwarz/TPMManager/commit/c287a841ac6b057ed35799949211866b9f533561.patch";
      hash = "sha256-2ZyUml8Q9bKQLVZWr18AzLt8VYLICXH9VDeq6B5Xfto=";
    })
  ];
