...
let param = {
  "2.4.2" = {
    hash = "sha256-Vjz9uybsijDnN6nPKFoG4LuulT9I4lu7D2n3qZwrpAs=";
  };
  "2.0.0" = {
    hash = "sha256-QHkZ+7DrlXYdb8bsZ3dijZSqGQc0O9ymeLGIC6+zOSI=";
  };
  "1.0.1" = {
    hash = "sha256-orvo5CAbYOmAurAeluQfK6CwW6P1C0T3WDfoovuQfSw=";
  };
  "1.0.0" = {
    hash = "sha256-tqoI6nGp662bK+vE2h7aDXE882dObVfRBFnZNChueqE=";
    max_version = "5.0";
  };
  "0.9.0" = {
    hash = "sha256-3w2tG605v03mvmZsS2O5c71y66O3W+n3JjFxIbXwvXk=";
    max_version = "5.0";
  };
}."${version}"; in
