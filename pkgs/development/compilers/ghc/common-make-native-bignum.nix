...
stdenv.mkDerivation (rec {
  ...
  patches = lib.optionals (lib.versionOlder version "9.4") [
    ...
    (fetchpatch {
      ...
      hash = "sha256-8w8QUCsODaTvknCDGgTfFNZa8ZmvIKaKS+2ZJZ9foYk=";
  ...
  ++ lib.optionals (lib.versionOlder version "9.2.2") [
    ...
    (fetchpatch {
      ...
      hash = "sha256-b4feGZIaKDj/UKjWTNY6/jH4s2iate0wAgMxG3rAbZI=";
    })
  ]
  ...
  ++ lib.optionals (lib.versionAtLeast version "9.2") [
    ...
    (fetchpatch {
      ...
      hash = "sha256-yRQ6YmMiwBwiYseC5BsrEtDgFbWvst+maGgDtdD0vAY=";
    })
  ]
