...
let
  ...
  variant = {
    "aarch64-darwin" = {
      ...
      hash = "sha256-J6+bOXX9uRdrGouMAxt7nROjjfH4P2txb1hmPoHUmdM=";
      prefix = "dar";
    };
    "aarch64-linux" = {
      ...
      hash = "sha256-oOO4zr0CssxVGIUIfmAujILqOfQf8dJPADkr03a8HAs=";
      prefix = "lin";
    };
    "x86_64-linux" = {
      ...
      hash = "sha256-rsXKgxKHldBKDjJTsOdJP4SxfxLmMPDY+GizBpuDeyw=";
      prefix = "lin";
    };
    "x86_64-darwin" = {
      ...
      hash = "sha256-bz2hQOaFbXePa8MhAZHESpZMRjjBH51IgvbR2EfBYMg=";
      prefix = "mac";
    };
  };
in
