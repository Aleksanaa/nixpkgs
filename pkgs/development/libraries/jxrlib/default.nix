...
stdenv.mkDerivation rec {
  ...
  patches = [
    (fetchpatch {
      ...
      hash = "sha256-BpCToLgA5856PZk5mXlwAy3Oh9aYP/2wvu2DXDTqufM=";
    })
    (fetchpatch {
      ...
      hash = "sha256-omIGa+ZrWjaH/IkBn4jgjufF/HEDKw69anVCX4hw+xQ=";
    })
    (fetchpatch {
      ...
      hash = "sha256-ZACaXEi+rbKIFBHtSBheyFfqV2HYsKKrT+SmTShyUhg=";
    })
  ];
